...
public final class DesktopItemSourceLocks {
    ...
    public static final class Source {
        ...
        private static Predicate<ItemStack> fingerprintMatcher(ItemStack fingerprint) {
            ...
            return stack -> ItemStack.isSameItemSameComponents(expected, stack);
        }
    }
    ...
    public static boolean isSelectedSlotLocked(Player player) {
        return isInventorySlotLocked(player, player.getInventory().getSelectedSlot());
    }
    ...
    public static boolean shouldRejectClick(
        ...
        if (input == ContainerInput.SWAP && isInventorySlotLocked(player, button)) {
            return true;
        }
        return input == ContainerInput.PICKUP_ALL && matchesLockedSource(player, carried);
    }
